...
#  seed3=222
  ...
  logdir="${logdir}/final_fix_test_params/" # baseline_mnist_50train_50test_1000itrs_lrelu_filtbias_nolastavgpool_firstconvk5_mom0-5_priscaled_repeats/${rep}/"
