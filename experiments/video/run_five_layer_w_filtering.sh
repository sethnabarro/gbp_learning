...
do
  ...
  logdir="${logdir}/final_conv_transpose/with_filtering_five_layer/"
  ...
  --n-iters-final-frame=500
  --n-train-eval-breaks=82
  --factors-pixel-obs-N-rob=0.2
  --factors-pixel-obs-sigma=0.2
  --factors-recon-sigma-layers 0.12 0.07 0.07
  --factors-recon-N-rob=2.5
  --factors-upsample-sigma=0.03
  --factors-recon-weight-prior-sigma-layers 0.15 0.3 0.3
  --factors-coeff-prior-sigma-layers 0.5 0.5 0.5
  ...
  --dropout=0.6
  --xla-compile
  --architecture='conv_tpose_five_layer_upsample_4'
  --weight-init-std=0.1
  --eval-crop-border=0
  --coeff-init-std=0.1
